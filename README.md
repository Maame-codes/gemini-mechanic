...
[![Gemini 3 Flash](https://img.shields.io/badge/AI-Gemini%203%20Flash-blue)](https://deepmind.google/technologies/gemini/)
...
* **One-Screen Mobile UI**: A custom-engineered layout using `100dvh` to ensure the interface remains locked and accessible even when the mobile keyboard is active.
* **No-Zoom Input Design**: Optimized with **16px** font-sizes to prevent intrusive iOS auto-zooming, ensuring a smooth user experience.
* **High-Speed Backend**: Built with **FastAPI** and protected by **SlowAPI** rate limiting for production-ready performance.
...
---
**Developed with ❤️ by Maame  for the MLH "Built with Google Gemini" Challenge.**
